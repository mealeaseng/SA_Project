...
export class Product implements OnInit {
  ...
  editProduct(id: string) {
    alert('Edit product functionality to be implemented for product: ' + id);
  }

  deleteProduct(id: string) {
    alert('Delete product functionality to be implemented for product: ' + id);
  }

  editCategory(id: string) {
    alert('Edit category functionality to be implemented for category: ' + id);
  }

  removeCategory(id: string) {
    alert('Remove category functionality to be implemented for category: ' + id);
  }
}
