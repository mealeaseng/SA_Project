...
export class Navbar implements OnInit {
  ...
  getCategoryCount() {
    console.log('getCategoryCount called'); // Debug log

    this.categoryService.getCategoryCount().subscribe({
      next: (response) => {
        console.log('API Response:', response); // Debug log
        this.Count_Categories = response.count;
        console.log('Count set to:', this.Count_Categories); // Debug log
      },
      error: (error) => {
        console.error('Error fetching category count:', error); // Debug log
