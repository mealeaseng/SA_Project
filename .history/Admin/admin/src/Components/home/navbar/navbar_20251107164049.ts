...
@Component({
  ...
  imports: [RouterOutlet, NgClass, NgIf, RouterLink, FormsModule], // Added NgIf
  templateUrl: './navbar.html',
  styleUrl: './navbar.css',
})
export class Navbar {
  sidebarOpen: boolean = false;
  searchQuery: string = ''; // Fixed: was searchTerm, should be searchQuery
  ...
  clearSearch() {
    this.searchQuery = ''; // Fixed: was searchTerm
