...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gray-50 p-4 sm:p-6">
      ...
      <!-- Summary Cards -->
      <div
        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-center items-center gap-4 mb-8"
      >
        <div
          class="bg-white rounded-xl shadow-sm p-5 text-center hover:shadow-md w-78 transition-shadow"
        >
