  ...
  template: `
    <div class="min-h-screen bg-gray-50 p-4 sm:p-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        <div
          class="bg-white rounded-xl shadow-sm p-5 text-center hover:shadow-md w-82 transition-shadow"
        >
          <h3 class="text-gray-600 font-medium mb-1">Total Users</h3>
          <p class="text-3xl font-bold text-blue-600">{{ totalUsers }}</p>
        </div>
        <div
          class="bg-white rounded-xl shadow-sm p-5 text-center hover:shadow-md w-84 transition-shadow"
        >
